...
insert into `bank_customer` values ('220-82-52237', "(주)한국전산", 2, '02-123-1045', '서울시 강서구');
...
insert into `bank_customer` values ('750210-2000003', "김춘추", 1, '010-1234-1002', '경기도 광주시');
...
insert into `bank_account` values ('101-11-2001', 'S1', '자유저축예금', '220-82-1000004', 230000000, '2003-04-14');
...
insert into `bank_account` values ('101-13-1005', 'S3', '주택청약예금', '941127-2000006', 720800, '2012-10-15');
...
insert into `bank_transaction` values (3, '101-11-1001', 2, 300000, now());
insert into `bank_transaction` values (4, '101-12-1001', 1, 1000000, now());
...
# 실습 2-18
select*from `bank_account` where `a_item_name` = '자유저축예금' order by `a_balance`desc limit 0, 1;
